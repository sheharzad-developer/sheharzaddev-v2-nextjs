export const projectsData = [
    ...
    },
    {
        ...
        subtitle: "Property & Maintenance Management Dashboard",
        description: "A full-stack property management platform for Eden Avenue with role-based access, maintenance request workflows, resident management, and real-time dashboard insights. Built with Next.js App Router, Prisma, and PostgreSQL, featuring secure authentication, PWA support, and a modern responsive UI.",
        img: "/projects/EdenAvenue.png",
        technologies: [
            "Next.js (App Router)",
            "TypeScript",
            "React",
        ...
        features: [
            "Role-based access for admins, managers, staff, and residents",
            "Maintenance request creation, assignment, status tracking, and comments",
            "Resident, staff, and property management with unit-level detail",
            "Dashboard with real-time statistics for requests, notices, residents, and staff",
            "Notices/announcements system with priority, publish state, and expiry",
            "Secure authentication with NextAuth and credential-based login",
