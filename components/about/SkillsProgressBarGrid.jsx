...
const skills = [
  ...
  { name: 'ExpressJS', level: 70, icon: <SiExpress className="text-gray-400" /> },
  ...
  { name: 'GitHub', level: 70, icon: <FaGithub className="text-gray-300" /> },
    ...
    >
      {skills.map((skill) => (
        ...
        >
          ...
          <div className="font-bold text-lg mb-1 text-white">{skill.name}</div>
          ...
          <div className="text-sm text-white">{skill.level}%</div>
        </div>
      ))}
    </div>
  );
